...
<template>
  <div class="flex flex-col h-full bg-gray-800/40 rounded-2xl border border-gray-700 shadow-2xl relative overflow-hidden">
     <!-- Chat History Area -->
     <div class="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar" ref="chatContainerRef">
        <div v-for="msg in chatMessages" :key="msg.id" 
            ...
            <!-- AI Message -->
            <div v-else class="max-w-[85%] bg-gray-800 text-gray-200 border border-gray-700 p-5 rounded-2xl rounded-tl-sm shadow-xl flex items-start gap-4">
        ...
        <div v-if="isAiThinking" class="flex justify-start">
           <div class="max-w-[75%] bg-gray-800 text-gray-400 p-4 rounded-2xl rounded-tl-sm border border-gray-700 flex items-center gap-3">
     ...
     <div class="p-4 bg-gray-800/80 border-t border-gray-700 backdrop-blur-sm">
        <div class="flex items-center gap-2 sm:gap-3 relative">
           ...
           <Button @click="$emit('toggle-recording')" 
                   ...
                   class="!p-3 lg:!p-4 !rounded-xl !border-none transition-all flex-shrink-0" 
                   title="Mikrofon: Sor veya Kaydet">
